 ...
 * which is injected into any netflix.com tab. It's responsible for receiving
 * messages from BackgroundScripts/netflix.js and performing a suitable action
 * (such as toggling if blur is enabled or not).
 */
